...
public class SignedReferences {
     ...
     * This is why there is not a <CODE>set</CODE> method for the signedReference property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the signedReference property.
     */
    public List<SignedReference> getSignedReference() {
        if (signedReference == null) {
            signedReference = new ArrayList<>();
        }
