...
import wsdl.oasis.names.tc.saml._2_0.assertion.EncryptedElementType;
...
public class ObjectFactory {
    ...
    private final static QName _UseIDResponse_QNAME = new QName("http://bsi.bund.de/eID/", "useIDResponse");
    private final static QName _UseIDRequest_QNAME = new QName("http://bsi.bund.de/eID/", "useIDRequest");
    private final static QName _GetServerInfoResponse_QNAME = new QName("http://bsi.bund.de/eID/", "getServerInfoResponse");
    private final static QName _GetServerInfoRequest_QNAME = new QName("http://bsi.bund.de/eID/", "getServerInfoRequest");
    private final static QName _GetResultRequest_QNAME = new QName("http://bsi.bund.de/eID/", "getResultRequest");
    private final static QName _GetResultResponse_QNAME = new QName("http://bsi.bund.de/eID/", "getResultResponse");
    private final static QName _EncryptedAuthnRequestExtension_QNAME = new QName("http://bsi.bund.de/eID/", "EncryptedAuthnRequestExtension");
    private final static QName _AuthnRequestExtension_QNAME = new QName("http://bsi.bund.de/eID/", "AuthnRequestExtension");
    ...
    public JAXBElement<UseIDResponseType> createUseIDResponse(UseIDResponseType value) {
        return new JAXBElement<UseIDResponseType>(_UseIDResponse_QNAME, UseIDResponseType.class, null, value);
    }
    ...
    public JAXBElement<UseIDRequestType> createUseIDRequest(UseIDRequestType value) {
        return new JAXBElement<UseIDRequestType>(_UseIDRequest_QNAME, UseIDRequestType.class, null, value);
    }
    ...
    public JAXBElement<GetServerInfoResponseType> createGetServerInfoResponse(GetServerInfoResponseType value) {
        return new JAXBElement<GetServerInfoResponseType>(_GetServerInfoResponse_QNAME, GetServerInfoResponseType.class, null, value);
    }
    ...
    public JAXBElement<NullType> createGetServerInfoRequest(NullType value) {
        return new JAXBElement<NullType>(_GetServerInfoRequest_QNAME, NullType.class, null, value);
    }
    ...
    public JAXBElement<GetResultRequestType> createGetResultRequest(GetResultRequestType value) {
        return new JAXBElement<GetResultRequestType>(_GetResultRequest_QNAME, GetResultRequestType.class, null, value);
    }
    ...
    public JAXBElement<EncryptedElementType> createEncryptedAuthnRequestExtension(EncryptedElementType value) {
        return new JAXBElement<EncryptedElementType>(_EncryptedAuthnRequestExtension_QNAME, EncryptedElementType.class, null, value);
    }
    ...
    public JAXBElement<AuthnRequestExtensionType> createAuthnRequestExtension(AuthnRequestExtensionType value) {
        return new JAXBElement<AuthnRequestExtensionType>(_AuthnRequestExtension_QNAME, AuthnRequestExtensionType.class, null, value);
    }
